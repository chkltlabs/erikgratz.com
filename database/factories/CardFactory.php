...
class CardFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'limit' => $this->faker->randomFloat(2, 0, 50000),
            'due_date' => $this->faker->numberBetween(1, 28),
            'pending' => $this->faker->randomFloat(2, 0, 5000),
            'interest_free_balance' => $this->faker->randomFloat(2, 0, 10000),
            'interest_saving_balance' => $this->faker->randomFloat(2, 0, 10000),
            'statement_date' => $this->faker->numberBetween(1, 28),
            'annual_fee' => $this->faker->randomNumber(3),
            'interest_free_balance_payment' => $this->faker->randomFloat(2, 0, 1000),
