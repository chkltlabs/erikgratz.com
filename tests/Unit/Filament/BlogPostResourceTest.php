...
test('blog post edit renders', function (){
...
test('blog post can edit', function (){
...
test('blog post can delete', function (){
    $post = BlogPost::factory()->create();
    Livewire::test(EditBlogPost::class, [
        'record' => $post->id
    ])
