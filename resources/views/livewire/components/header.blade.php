        ...
        >
            <div x-data="{ unselectedColor: 'text-gray-300',  selectedColor: 'text-purple-600' }"
                ...
                <div class="container mx-auto p-0 flex flex-wrap items-center md:flex-no-wrap">
                    ...
                    <div class="md:hidden flex-1 flex items-center justify-center">
                        <livewire:components.cv-button/>
                    </div>
                    {{-- hamburger menu --}}
                    ...
                    <div class="w-full md:w-auto md:grow md:flex md:items-center">
                        ...
                        <div
                            class="hidden md:flex flex-col mt-4 -mx-4 pt-4 border-t md:flex-row md:items-center md:mx-0 md:ml-auto md:mt-0 md:pt-0 md:border-0">
                            <livewire:components.cv-button/>
                        </div>
                    </div>
                </div>
