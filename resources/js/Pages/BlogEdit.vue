<template>
  ...
  containerActive: 'ring ring-green-500 ring-black/30',
  ...
  tagRemove: 'flex items-center justify-center p-1 mx-0.5 rounded-sm hover:bg-black hover:bg-black/10 group',
  ...
  caret: 'bg-multiselect-caret bg-center bg-no-repeat w-2.5 h-4 py-px box-content mr-3.5 relative z-10 opacity-40 shrink-0 grow-0 transition-transform transform',
  ...
  optionSelectedDisabled: 'text-green-100 bg-green-500 bg-black/50 cursor-not-allowed',
