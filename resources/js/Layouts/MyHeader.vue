            ...
            <div class="container mx-auto p-4 flex flex-wrap items-center md:flex-no-wrap">
                ...
                <div class="w-full md:w-auto md:flex-grow md:flex md:items-center">
                    <ul v-if="isNavOpen"
                        ...
                        <li>
                            <InertiaLink class="block px-4 py-1 md:p-2 lg:px-4"
...
export default {
    mixins: [VueClickAway],
    components: {InertiaLink, ResponsiveNavLink, NavLink, FadeTransition, Dropdown, ContactBox},
    props: {
        noteCount: Number,
    },
    data() {
